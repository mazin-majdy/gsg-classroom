            ...
            <div class=" mb-5 border-bottom py-2 d-flex justify-content-between">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a href="{{ route('topics.show', $topic->id) }}" class="dropdown-item" type="button">Show</a></li>
                        <li><a href="{{ route('topics.edit', $topic->id) }}" class="dropdown-item" type="button">Edit</a></li>
                        <li>
